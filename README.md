...
* The C++ is a tool for file analysis: create a minimalist analysis file about your file: occurrence, raw, text.
* The comments contain "Raw file bytes" - deal with file bytes as 0 to 255.
