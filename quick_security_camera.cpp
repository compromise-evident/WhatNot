...
{	ifstream in_stream;
	...
	{	//Makes file name, such as "2025-10-19_20:34:55___Sun_Oct_19_08:34:55_PM_MDT_2025.jpg".
		...
		string str = command; str += "Images/"; str += military_time; str += "___"; str += time; str += ".jpg";
