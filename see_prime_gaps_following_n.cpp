...
{	//Makes n prime.
	...
	of non-deterministic classification. So I refuse to use this in rolling-code 4.0.0,
	for now. Instead, this will be the core for a secure randomness generator. If this
	was deterministic, it would be also suitable for secure cryptographic difficulty
	and data crypt; "near which private prime, will I find these public gaps?" */
}
